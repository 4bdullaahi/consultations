                ...
                <div class="col-md-12">
                  ...
                  <div class="card mb-6">
                    ...
                    <div class="card-body pt-4">
                      <form id="formAccountSettings" method="POST" action="../saves/SaveAdmin.php" enctype="multipart/form-data">
                        <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-6 pb-4 border-bottom">
                        ...
                        <div class="button-wrapper">
                          <label for="upload" class="btn btn-primary me-3 mb-4" tabindex="0">
                            <span class="d-none d-sm-block">Upload Admins photo</span>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    if (!nameRegex.test(username)) {
      Swal.fire({icon: 'error', title: 'Invalid Name', text: 'Admin name must contain only letters and spaces.'});
      return;
    }
    ...
    .then(text => {
      ...
      if (data.success) {
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: data.message || 'Failed to save admin.'
        });
      }
    })
    .catch(error => {
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'An error occurred while saving admin.'
      });
    });
  });
