                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
                      <li class="nav-item">
                        <a class="nav-link active" href="addDoctor.php"
                          ><i class="icon-base bx bx-user icon-sm me-1_5"></i> Doctors</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="addPatient.php"
                          ><i class="icon-base bx bx-bell icon-sm me-1_5"></i> Patients</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="pages-account-settings-connections.html"
                          ><i class="icon-base bx bx-link-alt icon-sm me-1_5"></i> Admin</a
                        >
                      </li>
                    </ul>
                  </div>
